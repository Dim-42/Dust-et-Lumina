document.addEventListener("DOMContentLoaded", function() {
    ...
    function init3D() {
        ...
        const colorTexture = textureLoader.load("/Dust-et-Lumina/assets/images/map.png");
        ...
        addSector(0, 0.5, 0, 0.1, "星系核\nGalactic Core", "/Dust-et-Lumina/atlas/galactic-core/");
        addSector(0, 0.5, 5, 0.15, "猎户大星区\nMegasector of Orion", "/Dust-et-Lumina/atlas/megasector-of-orion/");
        addSector(2, 0.5, 4.3, 0.15, "慕洛里斯特别行政星区\nMeurloris District", "/Dust-et-Lumina/atlas/meurloris-district/");
        addSector(-6, 0.5, 2, 0.15, "拉文科尔星区\nLavencole Sector", "/Dust-et-Lumina/atlas/lavencole-sector/");
        addSector(1, 0.5, 4, 0.1, "奥德维克协和星区\nThe Aldwych Concordance", "/Dust-et-Lumina/atlas/aldwych-concordance/");
        addSector(7.5, 0.5, -0.5, 0.1, "埃尔泽兰独立星区\nEllzerand Independent Sector", "/Dust-et-Lumina/atlas/ellzerand-independent-sector/");
        ...
        container.addEventListener('pointermove', (e) => {
            ...
            if (intersects.length > 0) {
                ...
                container.style.cursor = 'url("/Dust-et-Lumina/assets/icons/target-2-svgrepo-com.svg") 12 12, pointer';
            } else {
                hoveredSector = null;
                info.innerText = "";
                container.style.cursor = 'url("/Dust-et-Lumina/assets/icons/target-2-svgrepo-com.svg") 12 12, default';
            }
        });
